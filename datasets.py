...
from shapenet_dataset import ShapeNet
...
def build_shape_surface_occupancy_dataset(split, args):
    if split == 'train':
        ...
        return ShapeNet(args.data_path, split=split, transform=transform, sampling=True, num_samples=2048, return_surface=True, surface_sampling=True, pc_size=args.point_cloud_size)
    elif split == 'val':
